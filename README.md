...
2. **Measure model inference time:**
   ...
   ```
   python get_inference_time.py --device gpu
   python get_inference_time.py --device cpu
   ```
...
| --------- | -------------------------- | -------------------------- | --------------------- | ----- | ----- | ------- | ----- | ----- |
| TF-Net s0 | 0.72/0.65                  | 2.7/2.4                    | 318.2/33.8     | 0.698 | 0.779 | 0.975   | 212.9 | 54.1  |
| TF-Net s1 | 2.6/2.3                    | 8.9/7.9                    | 166.5/17.5      | 0.711 | 0.792 | 0.976   | 182.0 | 47.8  |
